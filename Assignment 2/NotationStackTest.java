...
public class NotationStackTest {
	...
	public void testPopStudent() {
		try {
			assertEquals(term4, doubleS.pop());
			assertEquals(term3, doubleS.pop());
			assertEquals(term2, doubleS.pop());
			assertEquals(term1, doubleS.pop());
	...
	public void testPushStudent() {
		try {
			doubleS.pop();
			assertEquals(true, doubleS.push(term4));

			doubleS.push((Double)24.0);
			assertTrue("This should have caused an StackOverflowException", false);
		}
		catch (StackOverflowException e){
			assertTrue("This should have caused an StackOverflowException", true);
	...
	public void testToStringStudent() {
		try {
			assertEquals("24.49.05.40.5", doubleS.toString());
			doubleS.pop();
			doubleS.pop();
			assertEquals("24.49.0", doubleS.toString());
			doubleS.push(53.0);
			assertEquals("24.49.053.0", doubleS.toString());
		} catch (Exception e) {
